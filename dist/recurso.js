define(["require", "exports"], function (require, exports) {
    ...
    const recurso = ({ base, ordering, next, memoize, recurrence = DefaultRecurrence, tuplicity = getDefaultTuplicity(next, base), offset = 0, optimizeRuntime = false, }) => recursiveCase => {
    ...
    exports.recursoList = recursoList;
});
